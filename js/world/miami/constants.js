...
export const ALLEY_PIPE_CELLS = Object.freeze([
  ...
  [-110, 248],
  [-220, 248],
  // Gap between -390 and -250, miss GAP_X=-315. Appended so existing
  ...
  // hash01 alley pallet draws stay put. Fly +X.
  [-410, 248],
  // Extra z=181 pipes west of WASH_X0=-480. Appended so existing
  // hash01 alley-pipe draws stay put. Fly +X.
  [-720, 181],
  [-660, 181],
  // Gap between -390 and -350, miss GAP_X=-315. Appended so existing
  // hash01 alley-pipe draws stay put. Fly +X.
  [-370, 248],
  // Extra z=223 pipes between z=210 fill and z=237 skyline. Appended so
  ...
  [-630, 223],
  [-570, 223],
  // Extra z=181 pipes on west interstitial columns. Appended so existing
  // hash01 alley-pipe draws stay put. Fly +X. West of WASH_X0=-480.
  [-690, 181],
  [-630, 181],
  [-570, 181],
  [-390, 223],
  ...
  [-720, 248],
  [-600, 248],
  // Extra z=140 pipes between z=128 fill and z=152 fill. Appended so
  // existing hash01 alley-pipe draws stay put. Fly +X. West of leftoverLot A.
  [-720, 140],
  [-660, 140],
  [-600, 140],
  [-540, 140],
  // Extra z=140 pipes on west interstitial columns. Appended so existing
  // hash01 alley-pipe draws stay put. Fly +X. West of WASH_X0=-480.
  [-690, 140],
  [-630, 140],
  [-570, 140],
  // Extra z=140 pipes on x=-390/-370/-350/-280. Miss GAP_X=-315.
  // Appended so existing hash01 alley-pipe draws stay put. Fly +X.
  [-390, 140],
  [-370, 140],
  [-350, 140],
  [-280, 140],
  // Extra z=140 pipes on remaining 128/152 columns. Appended so existing
  ...
  [-600, 112],
  [-540, 112],
  // Extra z=112 pipes on west interstitial columns. Appended so existing
  // hash01 alley-pipe draws stay put. Fly +X. West of WASH_X0=-480.
  [-690, 112],
  [-630, 112],
  [-570, 112],
  // Extra z=112 pipes on x=-390/-370/-350/-280. Miss GAP_X=-315.
  // Appended so existing hash01 alley-pipe draws stay put. Fly +X.
  [-390, 112],
  [-370, 112],
  [-350, 112],
  [-280, 112],
  // Extra z=112 pipes on remaining 96/128 columns. Skip [-220,112]:
  // existing pipe at [-220,108]. Appended so existing hash01 alley-pipe
  // draws stay put. Fly +X. leftoverLot A–H unmoved.
  [-190, 112],
  [210, 112],
  // Mid-skyline interstitial alleys. Appended so existing hash01
  // alley-pipe draws stay put. Fly +X. leftoverLot A–H unmoved.
  [-60, 248],
  [-20, 248],
  [20, 248],
...
// west pair at x=-720 is 60 m west of -660. Both stay on the 1500 m
// city plate (x0=-729 > -750). New RESERVED west of x=240.
// Do not slide leftoverLot A–H.
...
export const INLAND_MIDRISE_CELLS = Object.freeze([
  ...
  [-110, 237], [-110, 259],
  [-220, 237], [-220, 259],
  // Gap between -390 and -250. Miss GAP_X=-315 (plate x1=-341 / x0=-289).
  [-350, 237], [-350, 259],
  [-280, 237], [-280, 259],
  ...
  [-410, 237], [-410, 259],
  // Gap between -390 and -350. Miss GAP_X=-315 (plate x1=-361 / shops west of -323.9).
  // Plate x0=-379 / x1=-361 sits 2 m off [-390] x1=-381 and [-350] x0=-359.
  [-370, 237], [-370, 259],
  ...
  [-720, 152], [-660, 152], [-600, 152], [-540, 152], [-455, 152], [-430, 152], [-410, 152], [-390, 152], [-370, 152], [-350, 152], [-280, 152], [-250, 152],
  [-220, 152], [-190, 152], [-160, 152], [90, 152], [110, 152], [130, 152], [160, 152], [190, 152], [210, 152],
  [-720, 210], [-660, 210], [-600, 210], [-540, 210], [-455, 210], [-430, 210], [-410, 210], [-390, 210], [-370, 210], [-350, 210], [-280, 210], [-250, 210],
  ...
  [-720, 96], [-660, 96], [-600, 96], [-540, 96], [-390, 96], [-370, 96], [-350, 96], [-280, 96], [-250, 96], [-220, 96], [-190, 96],
  [-160, 96],
  [210, 96],
  ...
  [-720, 128], [-660, 128], [-600, 128], [-540, 128], [-390, 128], [-370, 128], [-350, 128], [-280, 128], [-220, 128], [-190, 128],
  [210, 128],
  ...
  // Mid-skyline interstitial between -80/-40/0/40. 2 m alleys (same as
  // -430/-410). Convention/Washington reserved miss z=237/259.
  // leftoverLot A–H unmoved.
  [-60, 237], [-60, 259],
  [-20, 237], [-20, 259],
  [20, 237], [20, 259],
...
export const INLAND_ARCADE_CELLS = Object.freeze([
  ...
  [-220, 210],
  [-350, 237], [-280, 237],
  [-220, 96], [-220, 128], [-220, 152], [110, 152],
  [-350, 210], [-280, 210],
  [-350, 96], [-350, 128], [-350, 152],
  [-280, 96], [-280, 128], [-280, 152],
  [-455, 237],
  [-455, 210],
  [-455, 152],
  [-410, 237],
...
export const ROOF_AC_CELLS = Object.freeze([
  ...
  // Last z=152 arcade plates that miss court wells. Fly +X.
  // leftoverLot A–H unmoved.
  [-280, 152], [-370, 152], [-455, 152], [-410, 152], [160, 152], [110, 152],
  // z=128 arcade plates that miss court wells. Fly +X.
  // leftoverLot A–H unmoved.
  [-660, 128], [-540, 128], [-390, 128], [210, 128], [-690, 128],
]);
export const ROOF_RING_CELLS = Object.freeze([
  ...
  [-60, 259], [-20, 259], [20, 259],
  [0, 210], [-40, 210], [130, 210], [-350, 210], [110, 210],
  // Remaining z=210 arcade plates that miss court wells and roof-AC.
  // Fly +X. leftoverLot A–H unmoved.
  [-720, 210], [-690, 210], [-630, 210], [-570, 210], [-455, 210],
  // Last z=210 arcade plates that miss court wells and roof-AC.
  // Fly +X. leftoverLot A–H unmoved.
  [-410, 210], [-370, 210], [-280, 210], [-220, 210],
]);
...
export const FIRE_ESCAPE_CELLS = Object.freeze([
  ...
  [-729, 248], [-711, 248],
  [-549, 248], [-531, 248],
  // Extra flanks on x=-390/-190. Miss GAP_X=-315. Appended so existing
  // fire-escape draws stay put. Fly +X. leftoverLot A–H unmoved.
  [-399, 248], [-381, 248],
  [-199, 248], [-181, 248],
  // Extra flanks on x=-660/-350. Miss GAP_X=-315. Appended so existing
  // fire-escape draws stay put. Fly +X. leftoverLot A–H unmoved.
  [-669, 248], [-651, 248],
  [-359, 248], [-341, 248],
  // Extra flanks on x=160/210. West of leftoverLot A / x=240. Appended
  ...
  [-699, 248], [-681, 248],
  [-289, 248], [-271, 248],
  // Extra flanks on x=0/40. Miss GAP_X=57. Appended so existing
  // fire-escape draws stay put. Fly +X. leftoverLot A–H unmoved.
  [-9, 248], [9, 248],
  [31, 248], [49, 248],
  // Extra flanks on x=-630/-220. Appended so existing fire-escape
  // draws stay put. Fly +X. leftoverLot A–H unmoved.
  [-639, 248], [-621, 248],
  [-229, 248], [-211, 248],
  // Extra flanks on x=-570/130. Skip 80/190 (collide with 100/210).
  // Appended so existing fire-escape draws stay put. Fly +X.
  [-579, 248], [-561, 248],
  [121, 248], [139, 248],
  // Extra flanks on x=-600/-480. Miss GAP_X and WASH z-band.
  // Appended so existing fire-escape draws stay put. Fly +X.
  [-609, 248], [-591, 248],
  [-489, 248], [-471, 248],
